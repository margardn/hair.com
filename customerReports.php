            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <form action="customerReports.php" method="get" autocomplete="off">
...
<script>
    ...
    function drawBasic() {
        ...
        var data = google.visualization.arrayToDataTable([
            ...
            $customer = $rowCustomer['UserID'];

            $queryDetails = "select SUM(money_in), tblusers.Firstname, tblusers.Surname 
from tblappointments JOIN tblslots ON tblappointments.slotID=tblslots.slotID JOIN tblusers on 
    tblappointments.customerID=tblusers.UserID where tblappointments.complete=1 and tblappointments.customerID=$customer AND tblslots.start_event
        BETWEEN '$dateFrom' AND '$dateTo'";

            $resultDetails = mysqli_query($db, $queryDetails);
            $rowDetails = $resultDetails->fetch_assoc();
            $customerName = $rowDetails['Firstname'] . " " . $rowDetails['Surname'];
            ...
            ?>
            ['<?php echo $customerName ?>', <?php echo $detail ?>],
            <?php
            }
            }
            ?>
